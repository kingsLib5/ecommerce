...
function HomeSeven() {
  ...
  return (
    <>
      {/* MOBILE VERSION */}
      <div className="bg-white h-[80vh] block md:hidden">
        {/* New Arrival Header (Mobile) */}
        <motion.div
          className="ml-[20px] pt-[20px]"
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true }}
        ...
        {/* PlayStation 5 Section (Mobile) */}
        <motion.div
          className="mx-[20px] mt-[20px] bg-[url(./assets/ps5.jpg)] bg-center bg-cover flex flex-col pl-[20px] pt-[200px] text-white gap-[10px]"
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true }}
      ...
      {/* DESKTOP VERSION */}
      <div className="bg-white h-[80vh] hidden md:grid grid-rows-12">
        {/* Header Section */}
        <motion.div
        ...
        <div className="row-span-10 mx-[50px] grid grid-cols-2">
          ...
          {/* Right Column */}
          <motion.div
            className="hidden md:grid gap-[20px] grid-rows-2"
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true }}
            variants={{
          ...
          >
            ...
            <motion.div className="flex" variants={sectionVariants}>
              <div className="w-full bg-[url(./assets/wowo.jpg)] bg-center bg-cover text-white pt-[100px] pl-[40px] gap-[8px] flex flex-col">
                <motion.div variants={textVariants}>
